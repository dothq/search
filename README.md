...
<p align="center">
  <a href="https://search.dothq.co">
    <img alt="Search" src="https://cdn.dothq.co/assets/search.svg" width="60" />
  </a>
</p>
<h1 align="center">
  Dot Search <i>(search.dothq.co)</i>
</h1>

Welcome to the frontend side of the Dot Search website! Our pages are in `pages/`, the assets are at `src/images`, and fonts are at `src/fonts`.
...
1.  **Clone the repo**
    ...
    ```shell
    # cloning our repo...
    git clone https://git.dothq.co/search
    ```
